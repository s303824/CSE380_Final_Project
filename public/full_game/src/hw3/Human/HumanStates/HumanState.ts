 ...
 */
export default abstract class HumanState extends State {

    protected parent: HumanController;
	protected owner: HW3AnimatedSprite;
    protected player: HW3AnimatedSprite;
	protected gravity: number;

	public constructor(parent: HumanController, owner: HW3AnimatedSprite){
		super(parent);
		this.owner = owner;
        this.gravity = 500;
	}
