 ...
 */
export default class SewerCutscene extends HW3Level {
    ...
    public static readonly CUTSCENE_SPRITE_PATH = "hw4_assets/spritesheets/CutsceneSewers.json";
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.tilemapKey = SewerCutscene.TILEMAP_KEY;
        this.tilemapScale = SewerCutscene.TILEMAP_SCALE;
        this.wallsLayerKey = SewerCutscene.WALLS_LAYER_KEY;

        // Set the key for the player's sprite
        this.playerSpriteKey = SewerCutscene.PLAYER_SPRITE_KEY;
        // Set the player's spawn
        this.playerSpawn = SewerCutscene.PLAYER_SPAWN;

        // Music and sound
        this.levelMusicKey = SewerCutscene.LEVEL_MUSIC_KEY

        this.cutsceneSpriteKey = SewerCutscene.CUTSCENE_SPRITE_KEY;
        this.cutsceneSpawn = SewerCutscene.CUTSCENE_SPAWN;
    ...
    public loadScene(): void {
        // Load in the tilemap
        this.load.tilemap(this.tilemapKey, SewerCutscene.TILEMAP_PATH);
        // Load in the player's sprite
        this.load.spritesheet(this.playerSpriteKey, SewerCutscene.PLAYER_SPRITE_PATH);
       
        // Audio and music
        this.load.audio(this.levelMusicKey, SewerCutscene.LEVEL_MUSIC_PATH);

        // Cutscene
        this.load.spritesheet(this.cutsceneSpriteKey, SewerCutscene.CUTSCENE_SPRITE_PATH);
