...
export default class Level3 extends HW3Level {
    ...
    public static readonly TILEMAP_PATH = "hw4_assets/tilemaps/level-3.json";
    public static readonly TILEMAP_SCALE = new Vec2(2, 2);
    public static readonly WALLS_LAYER_KEY = "Main";

    public static readonly LEVEL_MUSIC_KEY = "LEVEL_MUSIC";
    public static readonly LEVEL_MUSIC_PATH = "hw4_assets/music/level3.mp3";
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        // enemies
        this.humanSpriteKey = Level3.HUMAN_SPRITE_KEY;
        this.humanSpawn = Level3.HUMAN_SPAWN;
        this.humanSpawn2 = Level3.HUMAN_SPAWN_2;
