 ...
 */
export default class CapturedCutscene extends HW3Level {
    ...
    public static readonly CUTSCENE_SPRITE_PATH = "hw4_assets/spritesheets/cutscene_captured.json";
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.tilemapKey = CapturedCutscene.TILEMAP_KEY;
        this.tilemapScale = CapturedCutscene.TILEMAP_SCALE;
        this.wallsLayerKey = CapturedCutscene.WALLS_LAYER_KEY;

        // Set the key for the player's sprite
        this.playerSpriteKey = CapturedCutscene.PLAYER_SPRITE_KEY;
        // Set the player's spawn
        this.playerSpawn = CapturedCutscene.PLAYER_SPAWN;

        // Music and sound
        this.levelMusicKey = CapturedCutscene.LEVEL_MUSIC_KEY

        this.cutsceneSpriteKey = CapturedCutscene.CUTSCENE_SPRITE_KEY;
        this.cutsceneSpawn = CapturedCutscene.CUTSCENE_SPAWN;
    ...
    public loadScene(): void {
        // Load in the tilemap
        this.load.tilemap(this.tilemapKey, CapturedCutscene.TILEMAP_PATH);
        // Load in the player's sprite
        this.load.spritesheet(this.playerSpriteKey, CapturedCutscene.PLAYER_SPRITE_PATH);
       
        // Audio and music
        this.load.audio(this.levelMusicKey, CapturedCutscene.LEVEL_MUSIC_PATH);

        // Cutscene
        this.load.spritesheet(this.cutsceneSpriteKey, CapturedCutscene.CUTSCENE_SPRITE_PATH);
