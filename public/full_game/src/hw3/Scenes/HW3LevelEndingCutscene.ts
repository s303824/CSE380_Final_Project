 ...
 */
export default class EndingCutscene extends HW3Level {
    ...
    public static readonly CUTSCENE_SPRITE_PATH = "hw4_assets/spritesheets/ending_cutscene.json";
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.tilemapKey = EndingCutscene.TILEMAP_KEY;
        this.tilemapScale = EndingCutscene.TILEMAP_SCALE;
        this.wallsLayerKey = EndingCutscene.WALLS_LAYER_KEY;

        // Set the key for the player's sprite
        this.playerSpriteKey = EndingCutscene.PLAYER_SPRITE_KEY;
        // Set the player's spawn
        this.playerSpawn = EndingCutscene.PLAYER_SPAWN;

        // Music and sound
        this.levelMusicKey = EndingCutscene.LEVEL_MUSIC_KEY

        this.cutsceneSpriteKey = EndingCutscene.CUTSCENE_SPRITE_KEY;
        this.cutsceneSpawn = EndingCutscene.CUTSCENE_SPAWN;
        this.isCutscene = true;EndingCutscene
    }
    ...
    public loadScene(): void {
        // Load in the tilemap
        this.load.tilemap(this.tilemapKey, EndingCutscene.TILEMAP_PATH);
        // Load in the player's sprite
        this.load.spritesheet(this.playerSpriteKey, EndingCutscene.PLAYER_SPRITE_PATH);
       
        // Audio and music
        this.load.audio(this.levelMusicKey, EndingCutscene.LEVEL_MUSIC_PATH);

        // Cutscene
        this.load.spritesheet(this.cutsceneSpriteKey, EndingCutscene.CUTSCENE_SPRITE_PATH);
